...
function App() {
  ...
  return (
    <div className="app">
      ...
      <FormSplitBill currFriend={currFriend} onSplitBill={handleSplitBill} />
    </div>
  );
}
...
function FormSplitBill({ currFriend, onSplitBill }) {
  ...
  function handleSubmit(e) {
    ...
    onSplitBill(whoPays === 'user' ? friendExpense : userExpense * -1);
  }
